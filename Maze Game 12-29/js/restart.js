...
12/13 fixing random values in checkedB, use queues to fix edge and checkedB
finish start screen,

12/27 problem solving checkedB and edges (checkedB fixed)

12/29 problem solving edges, using a class to fix edge issue(muliple or one??)
